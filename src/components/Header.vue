<template>
  <div class="header" :class="{ 'header--no-bg': withoutBG}">
    <div class="header__logo header__logo--left">
      <a class="header__logo-link" href="#">
         Playstation
        <svg 
          class="header__pl-svg" 
    ...
    <div class="header__logo header__logo--right">
      <a class="header__logo-link" href="#">
        YouTube
        <svg 
          class="header__logo-svg header__youtube-svg" 
          xmlns="http://www.w3.org/2000/svg" 
          width="178"
          height="40" 
          viewBox="0 0 409.69 91.46"
        >
          <defs>
            <svg:style type="text/css">
              .a { 
          ...
          <path d="M179.09,224.55A16.39,16.39,0,0,0,167.54,213c-10.19-2.72-51-2.72-51-2.72s-40.85,0-51,2.72a16.4,16.4,0,0,0-11.56,11.56C51.16,234.74,51.16,256,51.16,256s0,21.26,2.72,31.45A16.4,16.4,0,0,0,65.44,299c10.2,2.72,51.05,2.72,51.05,2.72s40.86,0,51.05-2.72a16.39,16.39,0,0,0,11.55-11.56c2.73-10.19,2.73-31.45,2.73-31.45S181.82,234.74,179.09,224.55Z" class="a" transform="translate(-51.16 -210.27)"/>
          <polygon points="52.28 65.33 86.22 45.73 52.28 26.13 52.28 65.33" class="b"/>
          <path d="M240.81,293.48a14.22,14.22,0,0,1-5.51-8.13,53.62,53.62,0,0,1-1.64-14.68v-8.31q0-9.26,1.87-14.86a14.84,14.84,0,0,1,5.84-8.17c2.64-1.7,6.11-2.58,10.41-2.58s7.63.88,10.19,2.62a15.08,15.08,0,0,1,5.61,8.17c1.18,3.7,1.76,8.65,1.76,14.8v8.31a51.44,51.44,0,0,1-1.72,14.72A14.33,14.33,0,0,1,262,293.5c-2.58,1.7-6.09,2.57-10.52,2.57S243.38,295.22,240.81,293.48Zm14.48-9c.71-1.87,1.08-4.93,1.08-9.15V257.5c0-4.12-.35-7.11-1.08-9a3.82,3.82,0,0,0-3.78-2.85c-1.75,0-3,1-3.7,2.85s-1.08,4.9-1.08,9v17.85c0,4.24.33,7.3,1,9.15a3.75,3.75,0,0,0,3.74,2.8A3.83,3.83,0,0,0,255.29,284.5Z" class="text" transform="translate(-51.16 -210.27)"/>
          <path d="M439.25,270.82v2.89a73.42,73.42,0,0,0,.33,8.27,7.71,7.71,0,0,0,1.35,4,3.88,3.88,0,0,0,3.18,1.27,4,4,0,0,0,4-2.24c.71-1.5,1.1-4,1.17-7.49l11.12.65a18.62,18.62,0,0,1,.08,2.06c0,5.3-1.46,9.25-4.35,11.86s-7,3.93-12.28,3.93q-9.54,0-13.37-6t-3.82-18.5v-10c0-8.61,1.33-14.86,4-18.83s7.17-5.93,13.59-5.93q6.65,0,10.19,2.44a13.06,13.06,0,0,1,5,7.56,55.44,55.44,0,0,1,1.45,14.2v9.81H439.25Zm1.64-24.11a8.07,8.07,0,0,0-1.31,4,74.34,74.34,0,0,0-.33,8.35v4.12h9.43V259a69.16,69.16,0,0,0-.37-8.35,8.13,8.13,0,0,0-1.35-4,3.76,3.76,0,0,0-3-1.17A3.58,3.58,0,0,0,440.89,246.71Z" class="text" transform="translate(-51.16 -210.27)"/>
          <path d="M209.42,269.74l-14.68-53h12.81l5.13,24c1.31,5.93,2.27,11,2.89,15.14H216q.65-4.5,2.89-15.05l5.32-24.11H237l-14.84,53v25.42h-12.7Z" class="text" transform="translate(-51.16 -210.27)"/>
          <path d="M311,237.87v57.27H300.9l-1.13-7h-.27c-2.74,5.31-6.85,7.94-12.32,7.94q-5.71,0-8.42-3.74c-1.81-2.49-2.7-6.38-2.7-11.68V237.87H289v42.05a12.85,12.85,0,0,0,.83,5.47,2.92,2.92,0,0,0,2.8,1.64,5.61,5.61,0,0,0,3.22-1,6.38,6.38,0,0,0,2.29-2.61V237.87Z" class="text" transform="translate(-51.16 -210.27)"/>
          <path d="M377.12,237.87v57.27H367l-1.12-7h-.28c-2.74,5.31-6.85,7.94-12.32,7.94q-5.7,0-8.42-3.74c-1.81-2.49-2.7-6.38-2.7-11.68V237.87h12.89v42.05a12.85,12.85,0,0,0,.83,5.47,2.92,2.92,0,0,0,2.8,1.64,5.61,5.61,0,0,0,3.22-1,6.38,6.38,0,0,0,2.29-2.61V237.87Z" class="text" transform="translate(-51.16 -210.27)"/>
          <path d="M346,227.13h-12.8v68H320.6v-68H307.8V216.76H346v10.37Z" class="text" transform="translate(-51.16 -210.27)"/>
          <path d="M419.79,247c-.79-3.62-2-6.23-3.78-7.86a10.16,10.16,0,0,0-7.19-2.43,11.82,11.82,0,0,0-6.63,2,13.53,13.53,0,0,0-4.76,5.28h-.11V213.87H384.89v81.29h10.64l1.31-5.42h.27a11,11,0,0,0,4.49,4.57,13.31,13.31,0,0,0,6.63,1.68,10.16,10.16,0,0,0,9.63-6c2.06-4,3.07-10.29,3.07-18.83v-9.06A74,74,0,0,0,419.79,247ZM408,270.4a69.58,69.58,0,0,1-.52,9.82,10.53,10.53,0,0,1-1.72,5,4,4,0,0,1-3.26,1.49,6.08,6.08,0,0,1-3-.75,5.65,5.65,0,0,1-2.2-2.24V251.24a8.1,8.1,0,0,1,2.25-3.82,4.93,4.93,0,0,1,3.45-1.5,3.48,3.48,0,0,1,3,1.54,12,12,0,0,1,1.5,5.17,100.2,100.2,0,0,1,.41,10.37v7.4Z" class="text" transform="translate(-51.16 -210.27)"/>
        </svg>
      </a><!-- /.header__logo-link -->
    </div><!-- /.header__logo header__logo--right -->
  </div><!-- /.header -->
</template>
